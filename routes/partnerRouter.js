...
.get((req, res) => {
    res.send(`Will send details of the partners: ${req.params.partnerId} to you`);
})
...
.put((req, res) => {
    ...
    res.send(`Will update the partner: ${req.body.name}
        with description: ${req.body.description}`);
})

.delete((req, res) => {
    res.send(`Deleting partner: ${req.params.partnerId}`);
});
